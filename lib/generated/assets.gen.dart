...
class $AssetsIconsGen {
  ...
  SvgGenImage get heartOutlined =>
      const SvgGenImage('assets/icons/heart_outlined.svg');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/demo_dish_1.png
  AssetGenImage get demoDish1 =>
      const AssetGenImage('assets/images/demo_dish_1.png');

  /// File path: assets/images/demo_dish_2.png
  AssetGenImage get demoDish2 =>
      const AssetGenImage('assets/images/demo_dish_2.png');

  /// File path: assets/images/demo_dish_3.png
  AssetGenImage get demoDish3 =>
      const AssetGenImage('assets/images/demo_dish_3.png');

  /// File path: assets/images/demo_dish_4.png
  AssetGenImage get demoDish4 =>
      const AssetGenImage('assets/images/demo_dish_4.png');

  /// List of all assets
  List<AssetGenImage> get values =>
      [demoDish1, demoDish2, demoDish3, demoDish4];
}
